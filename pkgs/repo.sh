...
[ -e $STAGE/repo ] && ( set -xe
    ...
    "centos" | "rhel")
        ...
        until sudo dnf config-manager --add-repo "https://developer.download.nvidia.com/compute/cuda/repos/rhel$DISTRO_VERSION_ID/x86_64/cuda-rhel$DISTRO_VERSION_ID.repo"; do echo "Retrying"; sleep 5; done
        ...
        (
            ...
            until sudo dnf install -y "$nvml_repo"; do echo "Retrying"; sleep 5; done
        )
