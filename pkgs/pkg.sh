    ...
    [ -e $STAGE/$i ] && ( set -xe
        ...
        for attempt in $(seq $RPM_MAX_ATTEMPT -1 0); do
            echo "
                ...
                [!] cuda
                [!] https://developer.download.nvidia.com/compute/machine-learning/repos/rhel7/x86_64/{libnccl{,-devel,-static}-2.4.7-1,libnvinfer{5,-devel}-5.1.5-1}+cuda10.1.x86_64.rpm
