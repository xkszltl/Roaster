...
export DEB_REFRESH="sudo DEBIAN_FRONTEND=noninteractive apt-get -o DPkg::Lock::Timeout=3600 update -y"
export DEB_UPDATE="sudo DEBIAN_FRONTEND=noninteractive apt-get -o DPkg::Lock::Timeout=3600 upgrade -y"
export DEB_INSTALL="sudo DEBIAN_FRONTEND=noninteractive apt-get -o DPkg::Lock::Timeout=3600 install -y"
export DEB_REINSTALL="sudo DEBIAN_FRONTEND=noninteractive apt-get -o DPkg::Lock::Timeout=3600 reinstall -y"
