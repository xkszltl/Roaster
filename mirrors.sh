...
Azure/{azure-{c-{build-tools,logging,shared-utility,testrunnerswitcher},cli{,-extensions},ctest,devops-{cli-extension,utils},sdk-{for-{android,cpp,go,ios,java,js,net,node,php,python,r,ruby,rust},tools},storage-cpp,utpm-c},AzureML-Containers,azureml-examples,iotedge,macro-utils-c,umock-c},\
benjaminp/six,\
