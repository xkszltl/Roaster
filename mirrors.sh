...
'"'" ::: {llvm-mirror/{ll{vm,d,db,go},clang{,-tools-extra},polly,compiler-rt,openmp,lib{unwind,cxx{,abi}},test-suite},jemalloc/jemalloc,aws/aws-{cli,sdk-{cpp,go,java,js,net,php,ruby}}}.git
